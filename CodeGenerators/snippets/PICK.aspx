...
<tr id="r-m-{idt}"> 
    ...
    <td class="ControlColumn">
        <uc:CBPickList2 ID="CBPicklist_{idt}" QuestionNumber="{idt}"  PickListID="{FK_PickListType}" AllowNA="true" runat="server" CSSClass="CustomControlValue"  EditState='ReadMode' AutoPostback="true" />
    </td>
    <td class="ControlColumn" >
