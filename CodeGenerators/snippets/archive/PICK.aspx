...
<tr id="r-m-{idt}" {Dependancy}> 
    ...
    <td class="ControlColumn">
        <uc:CBPickList2 ID="CBPicklist_{idt}"  PK_Question="{PK_Question}" PickListID="{FK_PickListType}" AllowNA="true" runat="server" CSSClass="CustomControlValue"  EditState='ReadMode' AutoPostback="true" />
    </td>
    <td class="ControlColumn" >
