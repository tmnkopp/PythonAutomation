<!-- 8.1  Does your agency have a centralized[1] patch management process? (yes/no) -->
<tr id="r-m-8.1" {Dependancy}>
    <td class="LabelColumn">
        <uc:CBlabel ID="CBlabel_8.1" LinkEditID="CBYesNo2_8.1" runat="server" CSSClass="CustomControlLabel" LabelType="QuestionNumber"  />
    </td>
...
<tr id="r-m-8.1.1" {Dependancy}>
    <td class="LabelColumn">
        <uc:CBlabel ID="CBlabel_8.1.1" LinkEditID="CBYesNo2_8.1.1" runat="server" CSSClass="CustomControlLabel" LabelType="QuestionNumber"  />
    </td>
    <td class="LabelColumn Question" >
...
<!-- 8.2  Does your patching prioritization process leverage significant automation?[2] (yes/no) -->
<tr id="r-m-8.2" {Dependancy}>
    <td class="LabelColumn">
        <uc:CBlabel ID="CBlabel_8.2" LinkEditID="CBYesNo2_8.2" runat="server" CSSClass="CustomControlLabel" LabelType="QuestionNumber"  />
    </td>
    <td class="LabelColumn Question" >
...
<tr id="r-m-8.3" {Dependancy}>
    <td class="LabelColumn">
        <uc:CBlabel ID="CBlabel_8.3" LinkEditID="CBYesNo2_8.3" runat="server" CSSClass="CustomControlLabel" LabelType="QuestionNumber"  />
    </td>
    <td class="LabelColumn Question" >
...
<!-- 8.4  Mean time to remediation of Known Exploited Vulnerabilities (KEVs) in days[3] -->
<tr id="r-m-8.4" {Dependancy}>
    <td class="LabelColumn">
        <uc:CBlabel ID="CBlabel_8.4" LinkEditID="CBYesNo2_8.4" runat="server" CSSClass="CustomControlLabel" LabelType="QuestionNumber"  />
    </td>
    <td class="LabelColumn Question" >
